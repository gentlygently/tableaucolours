<template>
    <div class="importcode">
        <div class="importcode-codecontainer">
            ...
            <div class="importcode-validationmessage" v-show="hasValidationMessage">{{ validationMessage }}</div>
        </div>
        <button class="importcode-button importcode-button--import" @click="importXml" :disabled="!isValid">Import</button>
